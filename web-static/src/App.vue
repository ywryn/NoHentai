...
const isReaderPage = computed(() => {
  return route.path.startsWith('/reader/') || route.path.endsWith('/read') || /\/gallery\/\d+\/translate$/.test(route.path)
})
    ...
    <div class="navigation-bar" v-show="!isReaderPage">
      <div class="nav-left">
        ...
        <ul class="icon-nav">
          ...
          <li>
            <RouterLink to="/translate" aria-label="Translate" title="Translate">
              <svg viewBox="0 0 24 24" aria-hidden="true">
      ...
      <ul class="nav-menu desktop-menu">
        ...
        <li><RouterLink to="/translate">Translate</RouterLink></li>
